...
public class UserInterface {
    ...
    public static void displayOrderMenu(Orders order) {
    ...
    public static void processAddSandwichRequest(Orders order) {
    ...
    public static void processAddDrinkRequest(Orders order) {
    ...
    public static void processAddChipsRequest(Orders order) {
        String[] chipTypeArr = {
